        ...
        void OnGUI ()
        {
            ...
            GUILayout.BeginVertical( "Create Image" , "window" );
            {
                ...
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    GUILayout.Label( _fileNumValues.ToString() , GUILayout.Width(100f) );
                }
                EditorGUILayout.EndHorizontal();
                ...
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    //
                    GUILayout.Label( "Resolution:" , GUILayout.Width(30f) );
                ...
                if( _filePath!=null )
                {
                    bool isSizeValid = (_owner.createImageSettings.resolution.latitude * _owner.createImageSettings.resolution.longitude) == _fileNumValues;
                    if( isSizeValid==false ){ EditorGUILayout.HelpBox( "RESOLUTION DOES NOT MATCH SELECTED CSV FILE\ntwo resolution values when multiplied have to equal number of data points in the csv file (data point for every pixel)" , MessageType.Warning ); }
                }
