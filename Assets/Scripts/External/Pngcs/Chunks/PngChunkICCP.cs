namespace Pngcs.Chunks {
    ...
    public class PngChunkICCP : PngChunkSingle {
        ...
        public override ChunkRaw CreateRawChunk() {
            ...
            System.Array.Copy((Array)(Pngcs.Chunks.ChunkHelper.ToBytes(profileName)), 0, (Array)(c.Data), 0, profileName.Length);
        ...
        public override void ParseFromRaw(ChunkRaw chunk) {
            int pos0 = Pngcs.Chunks.ChunkHelper.PosNullByte(chunk.Data);
            profileName = Pngcs.PngHelperInternal.charsetLatin1.GetString(chunk.Data, 0, pos0);
